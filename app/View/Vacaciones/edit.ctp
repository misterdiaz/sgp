...
<?php echo $this->Form->create('Vacacion'); ?>
	<fieldset>
		<legend><?php echo __('Edit Vacacion'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Vacacion.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Vacacion.id'))); ?></li>
