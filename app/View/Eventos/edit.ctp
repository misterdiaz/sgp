...
<h2>Editar evento: <? echo $this->data['Evento']['name']; ?></h2>
...
<?php echo $form->create('Evento');?>
	...
	<?php
		...
		echo $form->input('descripcion', array('label'=>array('text'=>'Descripción:', 'class'=>'span-4 derecha'), 'class'=>'span-18','div'=>array('class'=>'input textarea span-24 last')));
	?>
	</div>
	<div id="ubicacion">
	<?php
		...
		echo "</div>";
		echo "<div class='span-24 last'>";
		echo $form->input('pais_id', array('label'=>array('text'=>'Pais:', 'class'=>'span-4 derecha'), 'class'=>'span-6 last', 'div'=>array('class'=>'input select span-12')));
		echo $form->input('estado_id', array('label'=>array('text'=>'Estado:', 'class'=>'span-4 derecha'), 'class'=>'span-6 last', 'div'=>array('class'=>'input select span-12 last')));
		echo "</div>";
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('List Eventos', true), array('action'=>'index'));?></li>
		<li><?php echo $html->link(__('List Tipo Eventos', true), array('controller'=> 'tipo_eventos', 'action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('New Tipo Evento', true), array('controller'=> 'tipo_eventos', 'action'=>'add')); ?> </li>
		<li><?php echo $html->link(__('List Pais', true), array('controller'=> 'pais', 'action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('New Pais', true), array('controller'=> 'pais', 'action'=>'add')); ?> </li>
		...
		<li><?php echo $html->link(__('New Materiale', true), array('controller'=> 'materiales', 'action'=>'add')); ?> </li>
	</ul>
</div>
!-->
