...
$pdf->AddPage();
$pdf->Cell(0, 4, "Datos estadísticos de eventos durante el año $year - Mes: ".mes2letras($mes), 0, 1, 'C');
$pdf->Ln();
...
$pdf->Ln();
$y = $pdf->GetY();
$pdf->Image("graficos/graficos_mes_".$mes."_".$year.".png", $pdf->getX(), $y, 180);
$pdf->SetY($y+90);
$pdf->Cell(90, 6, "Gráfico de eventos según su tipo:", 0, 0, 'L');
$pdf->Cell(90, 6, "Gráfico de eventos según su nivel:", 0, 1, 'L');
$pdf->Image("graficos/graficos_torta_tipo_eventos_mes_".$mes."_".$year.".png", $pdf->getX(), $pdf->GetY()+15, 90);
$pdf->Image("graficos/graficos_torta_nacionalidad_mes_".$mes."_".$year.".png", $pdf->getX()+90, $pdf->GetY()+15, 90);
echo $pdf->Output("reporte_por_mes_".$year."_".mes2letras($mes).".pdf", 'D');
?>