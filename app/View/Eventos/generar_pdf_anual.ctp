...
$pdf->AddPage();
$pdf->Cell(0, 6, "Datos estadísticos de eventos durante el año $year:", 0, 1, 'C');
$pdf->Ln();
...
$pdf->Cell(0, 6, "Tipos de Eventos:", "LR", 1, 'L');
$pdf->Cell(0, 6, "$cadena", "LR", 1, 'L');
$pdf->Cell(94, 6, "Eventos Nacionales: ".$nacional[0][0]['count'], "L", 0, 'L');
$pdf->Cell(92, 6, "Eventos Internacionales: ".$internacional[0][0]['count'], "R", 1, 'L');
...
$pdf->Ln();
$y = $pdf->GetY();
$pdf->Image("graficos/graficos_anual_$year.png", $pdf->getX(), $y, 180);
$pdf->SetY($y+90);
$pdf->Cell(90, 6, "Gráfico de eventos según su tipo:", 0, 0, 'L');
$pdf->Cell(90, 6, "Gráfico de eventos según su nivel:", 0, 1, 'L');
$pdf->Image("graficos/graficos_torta_tipo_eventos_$year.png", $pdf->getX(), $pdf->GetY()+15, 90);
$pdf->Image("graficos/graficos_torta_nacionalidad_$year.png", $pdf->getX()+90, $pdf->GetY()+15, 90);
echo $pdf->Output("reporte_anual.pdf", 'D');
?>