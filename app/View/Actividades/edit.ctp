...
$this->Html->addCrumb('Editar actividad', '');
$this->request->data['Actividad']['fecha_inicio'] = turnFecha($this->data['Actividad']['fecha_inicio'], 2);
$this->request->data['Actividad']['fecha_culminacion'] = turnFecha($this->data['Actividad']['fecha_culminacion'], 2);
...
echo $this->Form->input('objetivo_id', array('type'=>'hidden'));
